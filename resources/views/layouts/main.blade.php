      ...
      <body>
                  ...
                  <div class="col-lg-6 text-center text-lg-right">
                          ...
                          @if (auth()->check())
                              ...
                              <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                      ...
                                      <a class="dropdown-item" type="button"href="{{ url('/logout') }}">Log Out</a>
                                  </div>
                              </div>
                          @else
                              <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                      <a class="dropdown-item" type="button"href="{{ url('/login') }}">Log in</a>
                                      <a class="dropdown-item" type="button"href="{{ url('/register') }}">Register</a>
                                  </div>
                              </div>
                          @endif
                          <div class="btn-group">
                      ...
                      <div class="d-inline-flex align-items-center d-block d-lg-none">
                          <a href="" class="btn px-0 ml-2">
                              ...
                              <span class="badge text-dark border border-dark rounded-circle" id="heartCount"
                                  style="padding-bottom: 2px">{{ count(session()->get('hearts', [])) }}</span>
                          </a>
                          <a href="" class="btn px-0 ml-2">
                              <i class="fas fa-shopping-cart text-dark"></i>
                              <span class="badge text-dark border border-dark rounded-circle" id="cartCount"
                  ...
                  <div class="col-lg-4 col-6 text-left">
                      <form action="{{ url('/shop') }}">
                          <div class="input-group">
                              <input name="keywords" type="text" value="{{ request()->get('keywords') }}"
                          ...
                          <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                              ...
                              <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                                  <a href="" class="btn px-0">
                                      ...
                                      <span id="heartCount" class="badge text-secondary border border-secondary rounded-circle"
                                          style="padding-bottom: 2px">{{ count(session()->get('hearts', [])) }}</span>
                                  </a>
                                  <a href="/cart" class="btn px-0 ml-3">
                                      <i class="fas fa-shopping-cart text-primary"></i>
                                      <span class="badge text-secondary border border-secondary rounded-circle" id="cartCount"
                                          style="padding-bottom: 2px">{{ count(session()->get('ids', [])) }}</span>
                                  </a>
                              </div>
                          </div>
          ...
          @yield('scripts')
          <script>
              function subscrideNewspaper(id) {
                  $.ajax({
                      url: '{{ url('/subscribe') }}',
                      data: {
                          id: id
