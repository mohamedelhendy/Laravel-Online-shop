                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" placeholder="example@email.com" name="email"
                                    value="{{ old('email') }}">
                                <?= $_REQUEST && !$email ? '<span class="text-danger">Please enter a valid value</span>' : '' ?>
                                @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                <label>Country</label>
                                <select class="custom-select"name="country" value="{{ old('country') }}">
                        ...
                        <div class="border-bottom">
                            ...
                            @foreach ($products as $product)
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p>${{ $product->getPrice() * $product['quantity'] }}</p>
                                </div>
                            @endforeach
                        </div>
