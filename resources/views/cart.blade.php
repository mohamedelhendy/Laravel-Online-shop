                    ...
                    <tbody class="align-middle" id="products">
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="input-group quantity mx-auto" style="width: 100px">
                                        ...
                                        <div class="input-group-btn">
                                            <a
                                                href="{{url('editCart?id='.$product['id'].'&comm=1')}}"class="decBtn btn btn-sm btn-primary btn-minus"><i
                                        ...
                                        <div class="input-group-btn">
                                            <a
                                                href="{{url('editCart?id='.$product['id'].'&comm=2')}}"class="incBtn btn btn-sm btn-primary btn-plus"><i
                                ...
                                <td class="align-middle">
                                    <a href="{{url('editCart?id='.$product['id'].'&comm=3')}}">
